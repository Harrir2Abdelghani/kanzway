  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50 transition-all duration-300 ease-in-out">
      <div className="bg-white w-11/12 max-w-lg p-6 rounded-lg shadow-2xl transform transition-transform duration-500 ease-out scale-95 hover:scale-100">
        ...
        {orderConfirmed ? (
          ...
          <>
            ...
            <button
              ...
              className="mt-6 w-full p-3 bg-teal-500 text-white font-semibold rounded-lg hover:bg-teal-600 transition-colors"
            >
              Confirm Order
            </button>
          </>
        ...
        <button
          onClick={onClose}
          className="mt-6 w-full p-3 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 transition-colors"
        >
          Close
        </button>
      </div>
